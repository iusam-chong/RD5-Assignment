            ...
            <div class="p-5">
              ...
              <form class="user">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="使用者帳號">
                </div>
                ...
                <div class="form-group">
                  <input type="password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="密碼確認">
                </div>
              ...
              <div class="text-center">
                <a class="small" href="login.php">登入</a>
              </div>
              <!--
              <div class="text-center">
