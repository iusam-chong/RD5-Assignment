          ...
          <div class="col-lg-6">
            <div class="p-5">
              ...
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">網路銀行</h1>
              </div>

              <form class="user">
                <div class="form-group">
                  <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="使用者帳號">
                </div>
                <div class="form-group">
              ...
              -->
              <div class="text-center">
                <a class="small" href="register.php">註冊網銀</a>
              </div>
            </div>
          </div>
        </div>
